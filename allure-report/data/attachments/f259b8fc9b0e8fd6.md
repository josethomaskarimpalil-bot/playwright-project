...
- Name: login.spec.js >> login with invalid username and invalid password performance_glitch_use1,secret_sauce1
- Location: tests\login.spec.js:58:1
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: performance_glitch_use1
          - generic [ref=e13]:
...
> 37 | await expect(this.page.locator('#nameofuser')).toBeVisible({timeout: 5000})
     |  ^ ReferenceError: expect is not defined
  38 | return this
  39 | }
  40 | }
  41 | module.exports = login
  42 | 
  43 | 
```